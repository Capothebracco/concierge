...
import {
  MessageCircle, ShieldCheck, Watch, Car, Ship, Key, Building2, Gem
} from "lucide-react";
    ...
    <div className="min-h-screen bg-black text-zinc-100 selection:bg-zinc-800/80">
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:py-28">
          <div className="max-w-4xl text-center mx-auto">
            ...
            <p className="mt-6 text-lg text-zinc-300 max-w-3xl mx-auto">
              From yachts to timepieces, we source the unobtainable for Dubai’s elite —
      ...
      <section id="services" className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card icon={<Watch className="h-5 w-5" />} title="Watches & Jewellery"
                desc="Daytona, Royal Oak, Nautilus, high jewellery commissions, vintage rarities." />
          <Card icon={<Car className="h-5 w-5" />} title="Supercars & Classics"
                desc="Ferrari allocations, GT models, bespoke specs, EU sourcing with UAE delivery." />
          <Card icon={<Ship className="h-5 w-5" />} title="Yachts & Tenders"
                desc="Off-market listings, survey & sea trials, buyer/seller representation." />
          <Card icon={<Key className="h-5 w-5" />} title="Hospitality & Access"
                desc="Priority reservations, private dining rooms, launch events, cultural access." />
          <Card icon={<Building2 className="h-5 w-5" />} title="Real Estate (Buy/Rent)"
                desc="Quietly sourced penthouses, villas, and investment opportunities, on and off-plan." />
          <Card icon={<Gem className="h-5 w-5" />} title="Special Commissions"
                desc="Limited objects, bespoke gifts, art acquisitions, ceremonial pieces." />
        </div>
      </section>
      ...
      <section id="faq" className="mx-auto max-w-7xl px-6 py-16 border-t border-white/10">
        ...
        <div className="mt-8 grid gap-4">
          <FAQ q="Do you require an upfront payment?"
               a="Yes. A search initiation deposit secures priority and is credited to the final purchase. This protects both parties and accelerates results." />
          <FAQ q="How fast can you deliver?"
               a="Watches and jewellery often within days; vehicles and yachts vary by inspection and logistics. Timelines are agreed at brief." />
          <FAQ q="Can you work with my family office or assistant?"
               a="Absolutely. We regularly coordinate with representatives and can sign bespoke NDAs." />
          <FAQ q="Do you ship internationally?"
               a="Yes, fully insured. Local handover in Dubai is also available by appointment." />
        </div>
      </section>
